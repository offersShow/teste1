...
function buscar() {
  ...
  fetch('https://meu-backend-flask-posa.onrender.com/buscar', {
    method: 'POST',
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch("https://meu-backend-flask-posa.onrender.com/ultima_busca")
    .then(res => res.json())
    .then(({ termo, dados }) => {
...
document.addEventListener("DOMContentLoaded", () => {
  fetch("https://meu-backend-flask-posa.onrender.com/promocoes")
    .then(res => res.json())
    .then(promo_cache => {
