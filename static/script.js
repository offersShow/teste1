...
function buscar() {
  ...
  fetch('https://meu-backend-flask-917g.onrender.com/api/buscar', {
    method: 'POST',
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch("https://meu-backend-flask-917g.onrender.com/api/ultima_busca")
    .then(res => res.json())
    .then(({ termo, dados }) => {
...
document.addEventListener("DOMContentLoaded", () => {
  fetch("https://meu-backend-flask-917g.onrender.com/api/promocoes")
    .then(res => res.json())
    .then(promo_cache => {
